...
export namespace ActionMessageUtils {
  ...
  const payloadCaseCtorMap = new Map<ActionMessage.PayloadCase, { new (): any }>([
    ...
    [ActionMessage.PayloadCase.SNSFORWARDMOMENTREQUEST, padlocal.SnsForwardMomentRequest],
    [ActionMessage.PayloadCase.SNSFORWARDMOMENTRESPONSE, padlocal.SnsForwardMomentResponse],
